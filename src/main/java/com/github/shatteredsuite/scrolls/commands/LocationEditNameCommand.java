...
public class LocationEditNameCommand extends WrappedCommand {
    ...
    public LocationEditNameCommand(ShatteredScrolls instance, LocationEditCommand parent) {
        super(
            instance, parent, "name", "shatteredscrolls.location.edit",
            "location-edit-name-cmd-help");
        this.parent = parent;
    ...
    public boolean onCommand(CommandSender sender, String label, String[] args) {
        ...
        if (args.length < 2) {
            ...
            instance.getMessenger()
                .sendErrorMessage(sender, "location-edit-name-cmd-help", msgArgs);
        }
        ...
        scrollLoc.name = builder.toString().trim();
