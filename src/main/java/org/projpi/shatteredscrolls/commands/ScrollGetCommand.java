...
public class ScrollGetCommand extends WrappedCommand
{
    ...
    public boolean onCommand(CommandSender sender, String label, String[] args)
    {
        ...
        {
            ((InventoryHolder) sender).getInventory().addItem(ScrollItemBuilder.getUnboundScroll(count, charges));
            return true;
        }
        else if(args[0].equalsIgnoreCase("location"))
        {
            ...
            ((InventoryHolder) sender).getInventory().addItem(ScrollItemBuilder.getBoundScroll(count, charges, location));
            return true;
        }
        else if(args[0].equalsIgnoreCase("position"))
        {
            ...
            ((Player) sender).getInventory().addItem(ScrollItemBuilder.getBoundScroll(count, charges, location));
            return true;
        }
        return true;
    }
