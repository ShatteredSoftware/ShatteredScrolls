...
public class LocationEditLocationCommand extends WrappedCommand
{
    ...
    {
        super(instance, parent, "location", "shatteredscrolls.location.edit.location", "location-edit-location-cmd-help");
        this.parent = parent;
    ...
    public boolean onCommand(CommandSender sender, String label, String[] args)
    {
        ...
        ScrollLocation scrollLoc = instance.getLocation(parent.parent.parent.getLocation(args, 0, sender));
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String alias, String[] args)
    {
        ...
        if(args.length == 2)
        {
            return parent.parent.parent.tabCompletePosition(args, 1, sender,
