...
public class ScrollConfig implements Cloneable, ConfigurationSerializable {
  ...
  public static ScrollConfig deserialize(Map<String, Object> map) {
    ...
    if (map.containsKey("scroll-unbound-name")
      ...
      unboundName =
          ChatColor.translateAlternateColorCodes('&', (String) map.get("scroll-unbound-name"));
    }
    ...
    if (map.containsKey("scroll-unbound-lore")
      ...
      unboundLore =
          ChatColor.translateAlternateColorCodes('&', (String) map.get("scroll-unbound-lore"));
    }
    ...
    ScrollCost cost =
        getIfValid(
            ...
            ScrollCost.class,
            new ScrollCost(
                ScrollCost.CostType.POTION, new PotionEffect(PotionEffectType.BLINDNESS, 5, 0)));
